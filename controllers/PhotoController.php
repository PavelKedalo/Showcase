<?php
    ...
    Class PhotoController Extends ControllerBase {
        ...
        public function index() {
            ...
            $modelPhoto = new PhotoModel($select);
            $photosInfo = $modelPhoto->getAllRows();//get all records
            ...
            $this->template->vars('photos', $photosInfo);//transfer photo to view
        ...
        public static function getForMain($select) {//get photo for index controller

            $modelPhoto = new PhotoModel($select);
            $photoInfo = $modelPhoto->getAllRows();//get all records

            return $photoInfo;
        }

        public function addToBasketAction($val = NULL) {//add photo to basket
        ...
        public function moreInfoAction($val = NULL) {
            ...
            $fields = implode(', ', array_keys(PhotoModel::fieldsToShow()));//get fields from model
            $modelElement = new PhotoModel($selectElement, $fields);//transfer fields to query
