<?php
    ...
    Class PeriodicalController Extends ControllerBase {
        ...
        public function index() {
            ...
            $modelPeriodical = new PeriodicalModel($select);
            $periodicalInfo = $modelPeriodical->getAllRows();//get all records
            ...
            $this->template->vars('periodicals', $periodicalInfo);//transfer periodicals to view
        ...
        public static function getForMain($select) {//get periodicals for index controller
        ...
        public function moreInfoAction($val = NULL) {
            ...
            $fields = implode(', ', array_keys(PeriodicalModel::fieldsToShow()));//get fields from model
            $modelElement = new PeriodicalModel($selectElement, $fields);//transfer fields to query
